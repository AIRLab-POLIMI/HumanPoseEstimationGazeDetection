...
def run_demo(args):
    ...
    TIME_OUT = 60 # How much time do i have if i'm searching a human during the interaction loop?
        ...
        if arduino.state_system == "busy":
            ...
            if interaction != 2 : #If I'm not interacting with the human
                ...
                if time_out_system_hum > TIME_OUT_HUM: #If there is no human for too long
                    ...
                    if arduino.new_dist > 110.0: #if the distance to the chld is bigger than , get closer
                        ...
                        tooCloseCount += 1
                        time_out_system_hum = 0
                        if tooCloseCount > 8: #If I'm too cloose for too much time ( I need this time window in order to let the children interact with the robot)
                        ...
                        if angle != 0:
                            ...
                            if JointAttention and duration_JA < JA_TIME:
                                ...
                                duration_JA = 0
                                actual_time_JA = 0                                                
                        print("Child Action: " + child_action + " | " + "Robot Action: " + functions_main.current_action + " | " + "Time Out Human {:.1f} / 30 Sec".format(time_out_system_hum) )
                    ...
                    print("Time out: {:.1f} / 60 ".format(time_out_system))
